...
- (void)layoutSubviewsInsideBounds:(CGRect)bounds
{
    ...
    if (_labelingPolicy == QLabelingPolicyTrimTitle)
    {
        ...
        if (self.detailTextLabel.text!=nil) {
            CGRect textRect = [self.detailTextLabel.text boundingRectWithSize:sizeWithMargin
                                                                options:NSStringDrawingUsesLineFragmentOrigin
                                                             attributes:@{NSFontAttributeName:self.detailTextLabel.font}
                                                                context:nil];
            valueSize = textRect.size;
        }
        ...
        if (!self.detailTextLabel.text) {
            ...
            CGRect textRect = [self.textLabel.text boundingRectWithSize:sizeWithMargin
                                                                      options:NSStringDrawingUsesLineFragmentOrigin
